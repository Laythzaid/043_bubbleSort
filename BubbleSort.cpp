...
void input()
{
    ...
    cout << "=====================" << endl;
    for (int i = 0; i < n; i++) //loop form 0 to n-1
    {
...
{
     //Procedure to sort the arrahy using bubble sort method 
     int pass = 1; //step 1
     ...
     do 
     {
        ...
        cout << endl;
     } while (pass <= n - 1); //step 5: contonute until all passes are done
    }
    void display()
    {
    cout << endl;
